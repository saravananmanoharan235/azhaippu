            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <form id="RegisterValidation" method="post" action="{{action('RiderController@update', $riderUuid)}}">
                        	...
                        	<div class="row">
                                <div class="col-md-6 ">
									<div class="form-group label-floating">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name"  required="true" value="{{$rider->name}}">
                                    </div>
								</div>
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
